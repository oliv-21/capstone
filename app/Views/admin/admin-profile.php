  ...
  <div class="wrapper">
    ...
    <nav id="adminSidebar" class="admin-sidebar col-lg-2 bg-white border-end ps-3 vh-100">
      ...
      <div class="d-flex flex-column align-items-start">
        ...
        <a href="<?= base_url(); ?>admin-admission" class="nav-link d-flex align-items-center">
          <i class="fas fa-users me-4 fa-lg fa-fw text-secondary"></i> Admission
        </a>
    ...
    <div class="main col-md-10">
          ...
          <div class="d-flex align-items-center ms-auto py-1">
            ...
            <div class="dropdown border-start border-2 ps-4">
              <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle"
                ...
                <img src="<?= base_url('public/assets/profilepic/' . esc($profilepic)) ?>" alt="Profile Image" class="me-2 rounded-circle" style="width: 40px; height: 40px; object-fit: cover;">
      ...
      <main class="px-4 py-4" style="height: calc(100vh - 56px); overflow-y: auto;">
        <h2 class="text-primary mb-4">
          <i onclick="window.location.href='<?= base_url(); ?>admin-dashboard'" class="fas fa-arrow-left me-3" style="cursor: pointer;"></i>Admin Profile
        </h2>
        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body">
            <form id="updateProfileForm" action="<?= base_url('admin/updateProfile') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <form id="changePasswordForm" action="<?= base_url('admin/changePassword') ?>" method="post">
              <div class="row g-3 mb-3">
                <div class="col-md-4">
