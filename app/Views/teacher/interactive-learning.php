...
<head>
  <meta charset="utf-8" />
  <title>Brightside Interactive Learning</title>
  ...
  <div class="wrapper d-flex">
    ...
    <nav id="teacherSidebar" class="admin-sidebar col-lg-2 bg-white border-end ps-3 vh-100">
      ...
      <div class="d-flex flex-column align-items-start">
        ...
        <a href="<?= base_url(); ?>teacher-interactive-learning" class="nav-link d-flex align-items-center active">
          ...
          <div class="row g-6">
            ...
            <div class="col-md-4">
              <div class="card shadow-sm border-0 h-100 text-center bg-pink p-4 rounded-4">
                ...
                <a href="<?= base_url(); ?>teacher-coloring-game" class="btn btn-outline-danger w-100">Play Now</a>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card shadow-sm border-0 h-100 text-center bg-green p-4 rounded-4">
                ...
                <a href="<?= base_url(); ?>teacher-shape-game" class="btn btn-outline-success w-100">Play Now</a>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card shadow-sm border-0 h-100 text-center bg-blue p-4 rounded-4">
                ...
                <a href="<?= base_url(); ?>teacher-animal-game" class="btn btn-outline-primary w-100">Play Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 mt-2">
           ...
           <div class="col-md-4">
            <div class="card shadow-sm border-0 h-100 text-center bg-yellow p-4 rounded-4">
              ...
              <a href="<?= base_url(); ?>teacher-number-game" class="btn btn-outline-warning w-100">Play Now</a>
            </div>
          </div>
            ...
            <div class="col-md-4">
              <div class="card shadow-sm border-0 h-100 text-center bg-purple p-4 rounded-4">
                ...
                <a href="<?= base_url(); ?>teacher-color-game" class="btn btn-outline-info w-100">Play Now</a>
              </div>
            </div>
          </div>
        </div>
